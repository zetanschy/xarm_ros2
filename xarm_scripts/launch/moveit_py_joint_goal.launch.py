#!/usr/bin/env python3
"""
Launch file for moveit_py_joint_goal script with use_sim_time parameter.
...
def generate_launch_description():
    ...
    # Node to run the moveit_py_joint_goal script
    # Note: use_sim_time must be set to True when running with Gazebo
    moveit_py_joint_goal_node = Node(
        package='xarm_scripts',
        executable='moveit_py_joint_goal',
        output='screen',
        parameters=[{
