...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config', 'hybrid_planning'),
            glob('config/hybrid_planning/*.yaml')),
        (os.path.join('share', package_name, 'config', 'visual_servo'),
            glob('config/visual_servo/*.yaml')),
    ],
